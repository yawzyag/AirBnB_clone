...
class TestBaseClass(unittest.TestCase):
    ...
    def setUp(self):
        self.juan = User()
        self.juan.email = "email"
        self.juan.password = "pass"
        self.juan.first_name = "name"
        self.juan.last_name = "name"
        self.juan.juanito = ""
    ...
    def test_email(self):
        self.assertEqual(self.juan.email, "email")

    def test_password(self):
        self.assertEqual(self.juan.password, "pass")

    def test_first(self):
        self.assertEqual(self.juan.first_name, "name")

    def test_last(self):
        self.assertEqual(self.juan.last_name, "name")
    ...
    def test_instance(self):
        self.assertIsInstance(self.juan, User)
    ...
    def test_dict(self):
        ...
        self.assertEqual(self.juan.__class__.__name__, "User")
        ...
        self.assertIsInstance(juanito2["email"], str)
